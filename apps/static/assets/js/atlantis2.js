...
$(document).ready(function(){
	...
	if(!toggle_sidebar2 && $('.sidenav-toggler2').length) {
		...
		$('.wrapper').mouseup(function(e)
		{
			let subject = $('.navbar-header-left'); 
...
let navItemClicked = $('.page-navigation > .nav-item');
